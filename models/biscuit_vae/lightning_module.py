...
class BISCUITVAE(pl.LightningModule):
    ...
    def _get_loss(self, batch, mode='train'):
        ...
        #print('hh', z_sample.shape, z_mean.shape, z_logstd.shape, x_rec.shape)
        ...
        if self.hparams.use_flow_prior:
            #print('here1')
            num_samples = 4
            #print('z_sample',z_sample.shape, z_mean.shape, z_logstd.shape)
        ...
        loss = (0.05*kld_t1_all + 0.95*rec_loss.sum(dim=1)).mean()
    ...
    def _get_loss_nf(self, batch, mode='train'):
        ...
        z_sample, z_mean, z_logstd = [t.unflatten(0, (imgs.shape[0], -1)) for t in [z_sample, z_mean, z_logstd]]
       

        #print('hhnf', z_sample.shape)
    ...
    def training_step(self, batch, batch_idx):
        ...
        print('Epoch number {}'.format(self.current_epoch))
        ...
        if self.current_epoch<=1:
            ...
            print('in the vae-nf training step')
            loss = self._get_loss_nf(batch, mode='train')
